...
const int TempPresADR = 0x76;  //DEBUG!  FIX!
...
//////////////////////////////////TP Downhole//////////////////////////////////
MCP3421 adc;
MS5803 Downhole(ADDRESS_HIGH, 2);  //DEBUG! FIX!
...
void InitLogFile(){
    ...
    (FileName + NumString + ".txt").toCharArray(FileNameC, 11);
    Serial.println(NumString); //DEBUG!
    #if defined(BARO)
  //      LogStr("Test");
